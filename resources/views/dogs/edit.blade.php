<x-web-layout>
                ...
                <div class="bg-white mt-8 shadow-md rounded-lg px-6 py-4 mb-8 flex flex-col md:flex-row md:items-center md:justify-between border border-gray-100">
                  ...
                  <ol class="list-reset flex flex-wrap items-center">
                      ...
                      <li><span class="mx-2 text-gray-400">/</span></li>
                      <li class="text-gray-700 font-semibold">Edit dog</li>
                  </ol>
                  </nav>
              </div>
          ...
          <div class="mx-auto">
            <div class="overflow-x-auto">
                ...
                <div class="mx-auto bg-white p-8">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Dog Information</h2>
                  
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label class="block text-gray-700 font-medium mb-2">Registered Name</label>
                        <input type="text" x-model="dogInfo.name"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none" />
                      </div>
                  
                      <div>
                        <label class="block text-gray-700 font-medium mb-2">Home Name</label>
                      ...
                      <div>
                        <label class="block text-gray-700 font-medium mb-2">Microchip</label>
                      ...
                      <div>
                        ...
                        <input type="date" x-model="dogInfo.dob"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none" />
                      </div>
                  
                      <div>
                        <label class="block text-gray-700 font-medium mb-2">Sex</label>
                        <select x-model="dogInfo.sex"
