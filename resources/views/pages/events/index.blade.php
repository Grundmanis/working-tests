    ...
    <div
        ...
        <nav class="text-sm text-gray-500 mb-3 md:mb-0">
            ...
            <a href="/dogs" class="text-blue-600 hover:underline font-medium">My Dogs</a>
                ...
                <li><span class="mx-2 text-gray-400">/</span></li>
                <li class="text-gray-700 font-semibold">My Events</li>
            </ol>
        </nav>
    </div>
                            ...
                            <td class="px-4 py-4" colspan="5">
                                <div class="w-full p-6 bg-white rounded-xl shadow-md space-y-6">
                                    ...
                                    <div
                                        ...
                                        <span class="mt-2 md:mt-0 text-sm font-medium text-blue-600">18 days
                                            left</span>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Kanta-Hämeen Noutajakoirayhdistys ry, Example
                                                Street 12, 12345 Hämeenlinna</p>
                                    ...
                                    <div class="p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <p class="mt-2 text-gray-700">
                                            <span class="font-medium">Exam secretary:</span> Kirsi Launomaa, 040 725
                                            5354, kirsi.launomaa@gmail.com
                                        </p>
                                    </div>

                                    <!-- Additional Information -->
                                    <div class="p-4 bg-gray-50 rounded-lg">
                                        <h2 class="text-lg font-semibold text-gray-800 mb-2">Additional Information
                                        </h2>
                                        <p class="text-gray-700 space-y-2">
                                            The event is intended only for members of the <span
                                                class="font-medium">Kanta-Hämeen Noutajakoirayhdistys ry</span>.
                                            Those with a result of <span class="font-medium">ALO1</span> or higher from
                                            the official NOME-B tests participate in the Champions class.
                                            The champions compete in the afternoon after about 12 o'clock.
                                            <br><br>
                                            The race is an unofficial checkpoint-type competition, with checkpoints for
                                            searching, steering, and marking.
                                            Everyone is welcome!
                                        </p>
                                    </div>
                                        ...
                                        <table class="min-w-full border border-gray-300">
                                            <thead class="bg-gray-100">
                                                <tr>
                                                    ...
                                                    <th class="border border-gray-300 px-4 py-2 text-left">Priority
                                                    </th>
                                                    <th class="border border-gray-300 px-4 py-2 text-left">Non-priority
                                                    </th>
                                                </tr>
                                            </thead>
