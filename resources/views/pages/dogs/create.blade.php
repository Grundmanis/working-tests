    ...
    <div
        ...
        <nav class="text-sm text-gray-500 mb-3 md:mb-0">
            <ol class="list-reset flex flex-wrap items-center">
                ...
                <li><span class="mx-2 text-gray-400">/</span></li>
                <li class="text-gray-700 font-semibold">{{ __('addDog') }}</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="overflow-x-auto">
                    <div class="overflow-x-auto">
                        ...
                        <div class="mx-auto bg-white p-8">
                            <h2 class="text-2xl font-semibold text-gray-800 mb-6">{{ __('dogInfo') }}</h2>
                            <x-error-alert :errors="$errors" />

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label
                                        class="block text-gray-700 font-medium mb-2">{{ __('registeredName') }}</label>
                                    <input type="text" name="registeredName" value="{{ old('registeredName') }}"
                                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none" />
                                </div>

                                <div>
                                    <label class="block text-gray-700 font-medium mb-2">{{ __('homeName') }}</label>
                                    <input type="text" name="homeName" value="{{ old('homeName') }}"
                                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none" />
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="breed"
                                        ...
                                        @foreach ($breeds as $key => $breed)
                                            <option @if (old('breed') == $key) selected @endif
