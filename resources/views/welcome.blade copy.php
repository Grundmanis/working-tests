        ...
        <header class="w-full">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div x-data="{ registerModal: false }" 
                        @open-register-modal.window="registerModal = true">
                        <!-- Trigger Button -->
                        <button 
            ...
            <div class="w-full">
              <img src="https://koekalenteri.snj.fi/static/media/banner_w1504.ba5aaa55c2379f6501fc.webp" alt="Header Image" class="w-full h-64 object-cover" />
            </div>
          </header>
...
<style>
  ...
  <div class="bg-gray-100 min-h-screen w-full flex  justify-center px-8">
    <div class="items-center w-full bg-white rounded-lg shadow-md mt-8 mb-8">
      <div class="mx-auto">
        <div class="overflow-x-auto">
          <div class="flex text-gray-700 rounded-lg bg-white w-full ">
            <!-- Filters Section -->
               <!-- Filters Section -->
...
<div class="p-6 bg-white rounded-xl shadow-md space-y-4">
    ...
    <div class="overflow-x-auto">
      <table class="min-w-full border border-gray-200 rounded-lg">
        <thead class="bg-gray-50">
          <tr>
            <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 border-b">Members</th>
            <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 border-b">Non-members</th>
            <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 border-b">Training</th>
          </tr>
        </thead>
        <tbody>
          <tr class="hover:bg-gray-50 transition-colors">
            <td class="px-4 py-3 border-b text-gray-800 font-medium">€10</td>
            <td class="px-4 py-3 border-b text-gray-800 font-medium">€10</td>
            <td class="px-4 py-3 border-b text-gray-800 font-medium">€10</td>
          </tr>
        </tbody>
    ...
    <p class="text-sm text-gray-600 mt-2">
      Payment can be made in cash or via bank transfer. Please keep the receipt for registration confirmation.
    </p>
  </div>
                    ...
                    <!-- Priorities -->
                    <div class="p-4 bg-gray-50 rounded-lg">
                      <h2 class="text-lg font-semibold text-gray-800 mb-2">Priorities</h2>
                      <p class="text-gray-700">Membership</p>
                    </div>
              ...
              {{-- <tr class="py-10 cursor-pointer border-b border-gray-200 hover:bg-gray-100"
                ...
                <td class="flex flex-row items-center p-4">
                  <div class="flex w-10 h-10 mr-4">
                    <a href="#" class="relative block">
                      <img alt="profil"
                        src="https://cdn-icons-png.freepik.com/512/197/197605.png"
                        class="object-cover w-10 h-10 mx-auto rounded-md" />
                    </a>
                  </div>
                  <div class="flex-1 pl-1">
              ...
              <tr class="py-10 cursor-pointer border-b border-gray-200 hover:bg-gray-100"
                ...
                <td class="flex flex-row items-center px-4 py-4">
                  <div class="flex w-10 h-10 mr-4">
                    <a href="#" class="relative block">
                      <img alt="profil"
                        src="https://cdn-icons-png.flaticon.com/512/323/323370.png"
                        class="object-cover w-10 h-10 mx-auto rounded-md" />
                    </a>
                  </div>
                  <div class="flex-1 pl-1">
